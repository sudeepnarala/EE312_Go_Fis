...
public:
    ...
    void bookCards(Card c1, Card c2);   // adds cards to book
...
//    bool rankInHand(Card c) const;
    ...
    Card chooseCardFromHand();  // Removed const
    ...
    // Return string containing cards in the hand
    string showHand() const;
    // Return string containing cards in the book
